...
{
    //-------------------------------------------------------------------------
    public class Interactable_FCButton : MonoBehaviour
    {
         public AudioSource audioSource;
         public AudioSource buttonClicked;
        public FC_Interacatble FC_Factory;
        ...
        {
          //  Debug.Log("FC: -- " + FC_Factory.isColliding());
        ...
        void OnCollisionEnter(Collision col)
        {
            ...
            if(col.gameObject.name == "HandColliderLeft(Clone)" || col.gameObject.name == "HandColliderRight(Clone)")
            {
                 Debug.Log("//////////////////////////////////////");
                    Debug.Log(col.gameObject.name);
                   if(buttonClicked.isPlaying == false)
                   {
                    buttonClicked.Play();
                    FC_Factory.generateCore();
                   }
                
               

            }
            /*if(attachedToHand == true && col.gameObject.name == "Prop_Core")
            {
                CreateHighlightRenderers();
                UpdateHighlightRenderers();
            }*/
