...
namespace VirtualGrasp.Controllers
{
    ...
    [HelpURL("https://docs.virtualgrasp.com/unity_vg_ec_unityinput." + VG_Version.__VG_VERSION__ + ".html")]
    public class VG_EC_UnityInteraction : VG_ExternalController
    {
#if VG_USE_UNITYINTERACTION_HAND
    ...
    private ActionBasedController m_controller = null;
        ...
        public VG_EC_UnityInteraction(int avatarID, VG_HandSide side, Transform origin)
        {
            m_avatarID = avatarID;
            m_handType = side;
            m_origin = origin;
            m_enabled = true;
            m_enablingDefine = "VG_USE_UNITYINTERACTION_HAND";
